...
const buttonElements = [['success', 'if(!locked)buy()', 'b', 'check', '<u>B</u>uy'], ['primary', 'if(!locked)sell()', 's', 'times', '<u>S</u>ell'], ['info', 'if(!locked)play()', 'c', 'play', '<u>C</u>ontinue'], ['danger', 'if(!locked)end()', 'e', 'fast-forward', '<u>E</u>nd'], ['info', 'restart()', 'r', 'sync', '<u>R</u>estart'], ['info', '', 't', 'cog', 'Se<u>t</u>tings']];
const header = createHeaderMenuRow('row justify-content-center', 'btn-group', headerElements, buttonElements);
